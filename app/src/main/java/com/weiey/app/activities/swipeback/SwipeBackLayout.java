...
public class SwipeBackLayout extends FrameLayout {
    ...
    private BaseSwipeBackActivity mActivity;
    ...
    public void addSwipeListener(OnSwipeListener listener) {
        if (mListeners == null) {
            mListeners = new ArrayList<OnSwipeListener>();
        }
    ...
    public void attachToActivity(BaseSwipeBackActivity activity) {
        mActivity = activity;
    ...
    class ViewDragCallback extends ViewDragHelper.Callback {
        ...
        public int getViewHorizontalDragRange(View child) {
            if (mFragment != null) {
                return 1;
            } else if (mActivity != null && ((BaseSwipeBackActivity) mActivity).swipeBackPriority()) {
                return 1;
            }
            return 0;
        }
