...
/**
 * @Description  侧滑关闭Fragment
 * 继承这个类实现，侧滑关闭Fragment
...
public class SwipeBackFragment extends Fragment {
    ...
    protected BaseSwipeBackActivity _mActivity;
    ...
    public void onAttach(Activity activity) {
        ...
        if (activity instanceof BaseSwipeBackActivity) {
            _mActivity = (BaseSwipeBackActivity) activity;
        } else {
            throw new RuntimeException(activity.toString() + " must extends BaseSwipeBackActivity");
        }
    }
