...
public class DES3Util {
    // 密钥
    private final static String secretKey = "qazwsxedcrfvtgbyhnujmikolp";
    // 向量
    ...
    public static String decode(String encryptText) throws Exception {
        ...
        byte[] decryptData = cipher.doFinal(Base64.decodeByte(encryptText));
    ...
    public static void main(String[] args) throws Exception {
        String org = "99999999999999999999";
