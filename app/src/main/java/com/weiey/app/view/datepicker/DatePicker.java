 ...
 * @Description  
 */
public class DatePicker implements View.OnClickListener, PickerView.OnSelectListener {
     ...
     */
    public DatePicker(Context context, Callback callback, String beginDateStr, String endDateStr) {
     ...
     */
    public DatePicker(Context context, Callback callback, long beginTimestamp, long endTimestamp) {
