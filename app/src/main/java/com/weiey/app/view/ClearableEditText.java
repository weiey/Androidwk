...
public class ClearableEditText extends AppCompatEditText implements View.OnTouchListener, View.OnFocusChangeListener, TextWatcher {
    ...
    public interface TextListener{
       void onTextEidtFinish(String text);
    }
    ...
    private Runnable delayRun = new Runnable() {
        ...
        public void run() {
            if(textListener != null){
                textListener.onTextEidtFinish(getText().toString());
            }
        }
    };
    ...
    private void init(final Context context) {
        final Drawable drawable = ContextCompat.getDrawable(context, R.drawable.ic_cancel_black_24dp);
